...
public class Field {
    ...
    // todo KLASA WEWNETRZNA ENUM Z POZYCJĄ W TABLICY 2D TJ TOP LEFT TOP MIDDLE TOP RIGTH MIDDLE LEFT MIDDLE MIDDLE MIDDLE RIGHT ITD A POTEM STREAM -> FILTER PO ENUMIE
}
